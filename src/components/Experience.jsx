...
const itemPlacement = {
  ...
  lowpoly: {
    ...
    teacher: { position: [-3, -1.7, -4] },
    board: { position: [-1, 0.7, -9.8] },
  },
};
...
useGLTF.preload("/models/classroom_anime.glb");
useGLTF.preload("/models/classroom_lowpoly.glb");
